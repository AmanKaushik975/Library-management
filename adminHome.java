...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BCA", "BTech", "MCA", "MTech", " " }));

        jLabel2.setText("Brach");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "EEE", "CS", "IT", "ECE", "AL&ML" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            st.executeUpdate("insert into student(rollno,course,bbranchName,name,gender,fathername) values('"+roll+"', '"+course+"', '"+branchName+"', '"+name+"', '"+gender+"', '"+fathername+"')");
